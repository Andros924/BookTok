...
import { BookOpen, Plus, Search, TrendingUp, Star, Users, Clock } from 'lucide-react'
    ...
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div className="px-4 py-6 sm:px-0">
          ...
          <div className="bg-white overflow-hidden shadow-lg rounded-lg border-l-4 border-orange-500">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500">Prestiti Totali</p>
          ...
          <div className="bg-white overflow-hidden shadow-lg rounded-lg border-l-4 border-red-500">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500">Prestiti Attivi</p>
                  <p className="text-2xl font-bold text-gray-900">{loanStats.active}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white overflow-hidden shadow-lg rounded-lg border-l-4 border-teal-500">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500">Restituiti</p>
                  <p className="text-2xl font-bold text-gray-900">{loanStats.returned}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Link
            to="/loans"
            className="bg-gradient-to-r from-orange-500 to-red-600 rounded-lg p-6 text-white hover:from-orange-600 hover:to-red-700 transition-all duration-200 transform hover:scale-105"
          >
            <div className="flex items-center">
              <Users className="h-8 w-8 mr-4" />
              <div>
                <h3 className="text-lg font-semibold">Gestisci Prestiti</h3>
                <p className="text-orange-100">Traccia i tuoi prestiti</p>
              </div>
            </div>
          </Link>
        </div>
